...
#### VHDL source files
set vhdl_src_files {}
lappend vhdl_src_files EnableGate.vhd
lappend vhdl_src_files ParityGenerator.vhd
lappend vhdl_src_files BarrelShifter.vhd

#### VHDL tstbench files
set vhdl_tb_files {}
lappend vhdl_tb_files tb_EnableGate.vhd
lappend vhdl_tb_files tb_ParityGenerator.vhd
lappend vhdl_tb_files tb_BarrelShifter.vhd
...
#### Waveform files
set wave_files {}
lappend wave_files EnbGate.wcfg
...
if {[llength $vhdl_src_files] > 0} {
  ...
  set_property top EnableGate [current_fileset]
  set_property top_lib work [current_fileset]
  set_property top_arch A_conc_sig_ass_1 [current_fileset]
...
if {[llength $vhdl_tb_files] > 0} {
  ...
  set_property top tb_EnableGate [get_filesets sim_1]
