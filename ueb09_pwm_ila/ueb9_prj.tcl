...
#### VHDL source files
set vhdl_src_files {}
lappend vhdl_src_files Rstsync.vhd
lappend vhdl_src_files pwm_dac.vhd
lappend vhdl_src_files pwm_led_ctrl.vhd
lappend vhdl_src_files pwm_led_data.vhd
lappend vhdl_src_files pwm_led_top.vhd

#### VHDL tstbench files
set vhdl_tb_files {}
lappend vhdl_tb_files tb_pwm_led_top.vhd

#### Constraints files
set const_files {}
lappend const_files pwm_led_top.xdc

#### Waveform files
set wave_files {}
lappend wave_files tb_pwm_led_top.wcfg
...
if {[llength $const_files] > 0} {
  ...
  foreach file $const_files {
    set_property used_in_synthesis false [get_files $ctr_dir/$file]
  } 
}
