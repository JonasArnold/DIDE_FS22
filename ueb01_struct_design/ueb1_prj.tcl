...
lappend vhdl_src_files MyXor.vhd
lappend vhdl_src_files MyOr.vhd
lappend vhdl_src_files HalfAdder.vhd
lappend vhdl_src_files FullAdder.vhd

#### VHDL tstbench files
set vhdl_tb_files {}
lappend vhdl_tb_files tb_FullAdder.vhd
